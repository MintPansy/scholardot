package swyp.scholardot.doc_units.docUnits;
...
public interface docUnitsRepository extends JpaRepository<docUnitsEntity, Long> {
     ...
     * @return 조회된 DocUnit 리스트
     */
    List<docUnitsEntity> findByDocumentIdAndStatusOrderByOrderInDocAsc(Long documentId, swyp.scholardot.doc_units.enums.UnitStatus status);

    long countByDocumentId(Long documentId);

    long countByDocumentIdAndStatus(Long documentId, swyp.scholardot.doc_units.enums.UnitStatus status);
}
