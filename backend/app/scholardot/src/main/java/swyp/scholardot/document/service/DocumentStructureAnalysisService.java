...
import swyp.scholardot.document.dto.PageStructureStats;
import swyp.scholardot.document.util.ComplexityScoreCalculator;
import swyp.scholardot.document.util.MathExpressionCounter;
...
public class DocumentStructureAnalysisService {
    ...
    @Value("${scholardot.complexity.weight-math:4.0}")
    private double complexityWeightMath;

    @Value("${scholardot.complexity.weight-image:2.0}")
    private double complexityWeightImage;

    @Value("${scholardot.complexity.weight-length:0.015}")
