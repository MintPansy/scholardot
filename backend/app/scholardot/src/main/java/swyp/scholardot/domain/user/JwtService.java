...
public class JwtService {
    ...
    public JwtService(
            @Value("${scholardot.jwt.secret}") String secret,
            @Value("${scholardot.jwt.access-ttl-seconds}") long accessTtlSeconds,
            @Value("${scholardot.jwt.refresh-ttl-seconds}") long refreshTtlSeconds
    ) {
