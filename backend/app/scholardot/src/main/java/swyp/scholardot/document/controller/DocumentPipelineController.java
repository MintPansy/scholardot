package swyp.scholardot.document.controller;
...
import swyp.scholardot.document.dto.DocumentStructureAnalysisResponse;
import swyp.scholardot.document.service.DocumentContentSummaryService;
import swyp.scholardot.document.service.DocumentHistoryService;
import swyp.scholardot.document.service.DocumentPipelineService;
import swyp.scholardot.document.service.DocumentService;
import swyp.scholardot.document.service.DocumentStructureAnalysisService;
...
public class DocumentPipelineController {
    ...
    public ResponseEntity<java.util.List<swyp.scholardot.document.dto.DocumentTranslationPairResponse>> getTranslationPairs(
        ...
        java.util.List<swyp.scholardot.document.dto.DocumentTranslationPairResponse> translationPairs =
    ...
    public ResponseEntity<swyp.scholardot.document.dto.DocumentTranslationProgressResponse> getTranslationProgress(
    ...
    public ResponseEntity<swyp.scholardot.document.dto.DocumentContentSummaryResponse> getContentSummary(
            @Parameter(description = "문서 ID", required = true) @PathVariable Long documentId
    ) {
    ...
    public ResponseEntity<Void> deleteDocument(@PathVariable Long documentId) {
        ...
        if (auth == null || !(auth.getPrincipal() instanceof JwtAuthFilter.ScholardotPrincipal principal)) {
    ...
    public ResponseEntity<java.util.List<swyp.scholardot.document.dto.DocumentTranslationHistoryItemResponse>> getTranslationHistories(
