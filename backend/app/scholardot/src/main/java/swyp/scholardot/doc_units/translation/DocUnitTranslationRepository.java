package swyp.scholardot.doc_units.translation;
...
public interface DocUnitTranslationRepository extends JpaRepository<DocUnitTranslation, Long> {
     ...
     */
    @Modifying
    @Query("DELETE FROM DocUnitTranslation t WHERE t.docUnit.documentId = :documentId")
    void deleteByDocUnitDocumentId(@Param("documentId") Long documentId);
